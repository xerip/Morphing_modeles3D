...
void MainWindow::on_add_vertex_clicked()
{
    ...
    if (!occ) list_vertex_control_src.push_back(val);
...
void MainWindow::on_add_vertex_2_clicked()
{
    ...
    if (!occ) list_vertex_control_tgt.push_back(val_2);
...
void MainWindow::on_pushButton_chargement_2_clicked()
{
    ...
    // boutons
    ui->add_vertex_2->setEnabled(true);
