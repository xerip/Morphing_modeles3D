...
void MainWindow::on_add_vertex_src_clicked()
{
    ...
    if (!occ) {list_vertex_control_src.push_back(val); std::cout<<"Sommet de contrôle ajouté : "<<val<<std::endl;}
    else std::cout<<"Sommet de contrôle déjà choisi"<<std::endl;
    std::sort(list_vertex_control_src.begin(),list_vertex_control_src.end());
    std::cout << "Liste de sommets de contrôle : ";
...
void MainWindow::on_add_vertex_tgt_clicked()
{
    ...
    if (!occ) {list_vertex_control_tgt.push_back(val_2); std::cout<<"Sommet de contrôle ajouté : "<<val_2<<std::endl;}
    else std::cout<<"Sommet de contrôle déjà choisi"<<std::endl;
