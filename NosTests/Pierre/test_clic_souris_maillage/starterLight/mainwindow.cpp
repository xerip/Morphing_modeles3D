...
{
    qDebug() << arg1;
    //this->setMaximum(mesh.n_vertices());
    /*if (arg!=(-1))
    {
        resetAllColorsAndThickness(&mesh);
        VertexHandle vh = _mesh->vertex_handle(num_vertex);
        _mesh->set_color(vh, MyMesh::Color(255, 255, 0));
        _mesh->data(vh).thickness = 15;
    }*/
    num_vertex=arg1;
    if (arg1>mesh.n_vertices())
        {
            qDebug() << "depassement du nmbre de sommets !";
        }
    else
        if (arg1!=(-1))
        {
            resetAllColorsAndThickness(&mesh);
            VertexHandle vh = mesh.vertex_handle(num_vertex);
...
void MainWindow::on_pushButton_chargement_clicked()
{
    ...
    //affiche_vertex_control(&mesh, tab_vertex);
