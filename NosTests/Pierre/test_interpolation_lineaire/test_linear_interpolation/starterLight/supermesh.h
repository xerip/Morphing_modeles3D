...
public:
    ...
    VertexHandle get_plus_proche_vh_of_triangle(MyMesh *_mesh, VertexHandle A, VertexHandle B, VertexHandle C, MyMesh::Point p, vector<bool> vertex_used);
    QVector3D linear_interpolation(QVector3D p0, QVector3D p1, float t);
    void build();
