...
void coords_barycentre(QVector3D A, QVector3D B, QVector3D C, QVector3D P, float &alpha)
{
...
//    mesh.data(sommets[4]).thickness = 8;
    ...
    coords_barycentre(QVector3D(1,0,0), QVector3D(0,1,0), QVector3D(0,0,1), QVector3D(0.5,0.5,0.25));
    qDebug() << "</" << __FUNCTION__ << ">";
}
