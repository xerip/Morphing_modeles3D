...
public:
    ...
    QPushButton *pushButton_fusion;
    QDoubleSpinBox *doubleSpinBox_pourcentage;
    QMenuBar *menuBar;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_fusion = new QPushButton(centralWidget);
        pushButton_fusion->setObjectName(QStringLiteral("pushButton_fusion"));
        pushButton_fusion->setEnabled(false);

        horizontalLayout->addWidget(pushButton_fusion);

        doubleSpinBox_pourcentage = new QDoubleSpinBox(centralWidget);
        doubleSpinBox_pourcentage->setObjectName(QStringLiteral("doubleSpinBox_pourcentage"));
        QSizePolicy sizePolicy1(QSizePolicy::Fixed, QSizePolicy::Fixed);
        sizePolicy1.setHorizontalStretch(0);
        sizePolicy1.setVerticalStretch(0);
        sizePolicy1.setHeightForWidth(doubleSpinBox_pourcentage->sizePolicy().hasHeightForWidth());
        doubleSpinBox_pourcentage->setSizePolicy(sizePolicy1);
        doubleSpinBox_pourcentage->setDecimals(1);
        doubleSpinBox_pourcentage->setMaximum(1);
        doubleSpinBox_pourcentage->setSingleStep(0.1);

        horizontalLayout->addWidget(doubleSpinBox_pourcentage);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        pushButton_superMesh->setText(QApplication::translate("MainWindow", "Construire PSM", Q_NULLPTR));
        pushButton_fusion->setText(QApplication::translate("MainWindow", "Fusion", Q_NULLPTR));
        doubleSpinBox_pourcentage->setPrefix(QApplication::translate("MainWindow", "t = ", Q_NULLPTR));
    } // retranslateUi
